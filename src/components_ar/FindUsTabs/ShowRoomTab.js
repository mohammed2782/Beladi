		...
		<View>
			<View style={{flexDirection :"column",alignItems:"center", paddingBottom:10}}>
				<View style={{flex:1,alignItems:"center"}}>
						<Image source = {require('../../../img/aftersales/showrooms_ar.png')} 
						 style={{flex: 1,
							width: 150,
							height: 90,
							resizeMode: 'contain'}}>
							  ...
							  <CardItem style={{paddingLeft:0,paddingRight:10}}>
								<Body >
									<View style={{flexDirection :"row-reverse",alignItems:"center",}}>
										<View style={{justifyContent:"flex-start", paddingLeft:30,paddingRight:15}}>
...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 11, fontFamily:"Futura Md BT Bold", color : "#FFF", marginBottom:10, marginTop:10, fontWeight: 'bold', paddingLeft:20},
