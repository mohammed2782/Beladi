		...
		return (
				<ImageBackground style={styles.backgroundImage}
					...
					<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
						<View style={{flexDirection : "row-reverse" ,marginTop:20,marginRight:20,marginLeft:20,
							...
							<View style={{flex:2,flexDirection:'column', alignItems:"flex-start" , justifyContent:"flex-start"}}>
								<View style={{flex:3,flexDirection:"row-reverse",justifyContent:"flex-start"}}>
									...
									<View style={styles.contentContainer}>	
										<Tabs 
											...
											<Tab 
												...
												textStyle={{color: '#D3D3D3' , fontSize:14}} 
												activeTabStyle={styles.activeTab}  
												activeTextStyle={{color:"black", fontSize:14}}
