...
export class PromoItem extends Component {
	...
	getTitle (promo){
		...
		//alert (s);
		return (<View><Text style={styles.endAtTitle}>{promo.validUntil} ساري إلى </Text>
        ...
        <Card style={styles.mb,{marginLeft:0,marginRight:0,flex:1}}>
			<CardItem style={{paddingLeft:5}}>
				<Left>
					...
					<View style={{flex:1 , flexDirection : 'column', alingItems:"flex-end", paddingLeft:10}}>
						<Text style={styles.oldPriceText}>
							السعر الأصلي {this.props.promo.currency} {this.props.promo.oldPrice.toLocaleString('en')}
						</Text>
						<Text style={styles.newPriceText}>
							الأن {this.props.promo.currency} {this.props.promo.newPrice.toLocaleString('en')}
						</Text>
			...
			<View style={{position: 'absolute',
				...
				<View style={{flexDirection : "row" , justifyContent:"center" , alignItems:"center", flex:1}}>
					<Button block onPress={() => 
						...
						<Text style={{color:"white",fontSize:15}}>أحصل على هذا العرض</Text>
					</Button>
				</View>
