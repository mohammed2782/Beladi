...
import {BeladiHeader_ar} from './BeladiHeader_ar';
...
import { withNavigationFocus } from 'react-navigation';
	 class HomeScreen_ar extends Component {
		constructor(props) {
			super(props);
			this.state = {
				active: false,
		...
		onOpened(openResult) {
			...
			if (routeScreen =='PROMO'){
				this.props.navigation.navigate("EcommerceMaster_ar");
		...
		async  saveOneSignalPlayerId (){
		 ...
		 _methodToReloadOnOilPopUpClose = async ()=>{
			...
			const changeOil = await api.checkOilShouldChange(this.state.zuserid , 'AR');
			...
			return (
				<ImageBackground style={styles.backgroundImage}
					...
					<View style={styles.MainContainer}>	
						<View style={{flex:2}}>
							<BeladiHeader_ar navigation={this.props.navigation}/>
						</View>
								...
								<ImageBackground style={styles.backgroundImage}
									...
									<View style={{flex:16,justifyContent:"flex-end",alignItems:"center"}}>
										...
										<Text style={{fontSize:10,marginTop:10}}>
											شركة بلادي للسيارات وخدمات الصيانه
										</Text>
									</View>
									<View style={{flex:2}}/>
							...
							<View style={{flex:6 ,flexDirection:"row",  }}>
								<View style={{ flex:1,flexDirection:"column", justifyContent:"space-around"}}>
										...
										<View style={{ flex:1,flexDirection:"column"}}>
											<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("ReservationPage_ar")}>
												<ImageBackground  style={styles.backgroundImageBTN} 
													...
													<View style={{ flex:4,flexDirection:"column",}}>
														...
														<View style={{flex:1,alignItems:"center",}}>
															<Text style={styles.btnText}>حجز موعد</Text>
														</View>
									...
									<View style={{ flex:1,flexDirection:"column"}}>
										<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("EcommerceMaster_ar")}>
											<ImageBackground  style={styles.backgroundImageBTN} 
											resizeMode = "contain" source={require('../../img/landingpage/middle.png')} blurRadius={0}>
												...
												<View style={{ flex:4,flexDirection:"column",}}>
													...
													<View style={{flex:1,alignItems:"center",}}>
														<Text style={styles.btnText}>قطع غيار</Text>
													</View>
												</View>
											</ImageBackground>
										</Button>
									...
									<View style={{ flex:1,flexDirection:"column"}}>
										<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("Centers_ar")}>
											<ImageBackground  style={styles.backgroundImageBTN} 
											resizeMode = "contain" source={require('../../img/landingpage/left2.png')} blurRadius={0}>
												...
												<View style={{ flex:4,flexDirection:"column",}}>
													...
													<View style={{flex:1,alignItems:"center",}}>
														<Text style={styles.btnText}>مراكزنا</Text>
													</View>
												</View>
											</ImageBackground>
										</Button>
								...
								<View style={{flex:1}}>
									...
									<View style={{ flex:1,flexDirection:"column", justifyContent:"space-around"}}>
										<View style={{ flex:1,flexDirection:"column"}}>
											<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("VerifyParts_ar")}>
												<ImageBackground  style={styles.backgroundImageBTN} 
												resizeMode = "contain" source={require('../../img/landingpage/right1.png')} blurRadius={0}>
													...
													<View style={{ flex:4,flexDirection:"column",}}>
														...
														<View style={{flex:1,alignItems:"center",}}>
															<Text style={styles.btnText}>تحقق من قطع الغيار</Text>
														</View>
													</View>
												</ImageBackground>
											</Button>
										...
										<View style={{ flex:1,flexDirection:"column"}}>
											<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("AboutUs_ar")}>
												<ImageBackground  style={styles.backgroundImageBTN} 
												resizeMode = "contain" source={require('../../img/landingpage/middle.png')} blurRadius={0}>
													<View style={{flex:1}}/>
													<View style={{ flex:4,flexDirection:"column",}}>
														...
														<View style={{flex:1,alignItems:"center",}}>
															<Text style={styles.btnText}>من نحن</Text>
														</View>
													</View>
												</ImageBackground>
											</Button>
										...
										<View style={{ flex:1,flexDirection:"column"}}>
											<Button transparent style={{width:"100%",height:"100%"}} onPress={() => this.props.navigation.navigate("ContactUs_ar")}>
												<ImageBackground  style={styles.backgroundImageBTN} 
												resizeMode = "contain" source={require('../../img/landingpage/right2.png')} blurRadius={0}>
													...
													<View style={{ flex:4,flexDirection:"column",}}>
														...
														<View style={{flex:1,alignItems:"center",}}>
															<Text style={styles.btnText}>إتصل بنا</Text>
														</View>
													</View>
												</ImageBackground>
											</Button>
	...
	export default withNavigationFocus(HomeScreen_ar);