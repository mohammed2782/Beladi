				...
				<ImageBackground style={styles.backgroundImage}
					...
					<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
						<View style={{backgroundColor:"#004777",flex:1,paddingTop:10,alignItems:"center", paddingLeft:0}}>
							<View style={{flexDirection : "row", backgroundColor:"#004777", flex:1,
								paddingLeft:0}}>
						...
						<View style={{flex:4, marginTop:10 , marginLeft:20 , marginRight:20}}>
	...
	const styles = StyleSheet.create(
		{
			...
			activeTab :{backgroundColor:"#fff",borderTopColor:"#D3D3D3", borderRightColor:"#D3D3D3" , borderBottomColor:"blue", 
				borderTopRightRadius:7,paddingLeft:0,paddingRight:0, borderTopLeftRadius:7, borderLeftColor:"#d1251a",borderLeftWidth:10, borderTopWidth:1,borderRightWidth:1},
