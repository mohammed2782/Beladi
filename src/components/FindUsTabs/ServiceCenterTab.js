...
class ShowRoomTab extends Component {
	...
	async componentDidMount(){
			...
			const showRooms = await api.fetchServiceCentersListBeladi('EN');
  ...
  render () {
	...
	<Content padder style={{ marginTop: 0 }}>
		<View style={{flex:1}}>
			<View style={{flexDirection :"row",flex:1,alignItems:"center",justifyContent:"center", paddingBottom:10, }}>
