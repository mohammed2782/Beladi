...
import AsyncStorage from '@react-native-community/async-storage';
	export  class PerodicalMaintenance extends Component <{}> {
		...
		async componentDidMount(){
			...
			const rangesListJSON = await api.fetchPerodicalRangesListBeladi('en', zuidInPhone);
								...
								<FlatList 
									...
									<Card style={styles.mb,{marginLeft:0,marginRight:0}}>
										<CardItem cardBody style={{borderBottomWidth:0.5,borderBottomColor: 'grey',
											...
											<View style={{flex:1, alignItems:"center",backgroundColor:"#FAFAFA",justifyContent:"center", alignSelf:"center" , flexDirection:"row"}}>
