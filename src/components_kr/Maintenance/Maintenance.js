...
import { withNavigationFocus } from 'react-navigation';
	 class Maintenance_kr extends Component  {
		_isMounted = false;
		constructor (props){
			super(props);
			//alert("this is const");
				...
				<View style={styles.formRow}>
					...
					<View style={{flexDirection : "row" , justifyContent:"center",borderRadius:10 , alignItems:"center", flex:1}}>
						<Button block onPress={()=> {this._saveNewMileage();}}
							...
							<Text style={{color:"white", fontSize:11}}>داخلَكردنى كيلؤمتر</Text>
							</Button>
					</View>
				</Form>
			);
	...
	export default withNavigationFocus(Maintenance_kr);
