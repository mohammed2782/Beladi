			...
			<ImageBackground style={styles.backgroundImage}
				...
				<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
					...
					<View style={{flexDirection : "row-reverse" , justifyContent:"flex-start" , alignItems:"center", flex:1,
						...
						<Text style={{fontFamily:"Franklin Gothic Book Regular",paddingTop:10 , fontSize:14, fontWeight:"bold" ,color:"black"}}>
						...
						<Form style={styles.form}>
									...
									<View style={styles.formRow}>
										...
										keyboardType={'numeric'}
											name = "custHP1" placeholder="ژماره‌ی ته‌له‌فۆن"
...
const styles = StyleSheet.create(
	{
		...
		textInputStyle :{ height:35 ,textAlign :'right',borderColor: 'gray',backgroundColor :"#FFF", borderWidth: 1, flex:1 , fontSize :13 , paddingTop:10 ,
		lineHeight:10 , borderRadius:7 , marginBottom : 10},
		labelStyle : {fontFamily:"Franklin Gothic Book Regular" , fontSize:14 ,color:"#d1251a" , paddingRight : 5,paddingLeft:10 , marginBottom:10},
