	...
	return (
		<View style={{flexDirection : "row-reverse" , justifyContent:"space-between", flex:1,
			...
			<Button	transparent onPress={() => navigation.goBack()}>
				<Image source={require("../../img/back_ar.png")}  style={{ paddingTop:0,
					width: 30,
					height: 30,
					resizeMode: 'contain'}}/>
			</Button>
			...
			<View style={{flex:6,marginLeft:10, flexDirection : "column",justifyContent:"flex-start", alignItems:"flex-end" }}>
